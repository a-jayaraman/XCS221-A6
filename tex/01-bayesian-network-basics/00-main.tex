...
\begin{enumerate}
  ...
  \input{01-bayesian-network-basics/01-second-timestep-sol}

  \input{01-bayesian-network-basics/02-third-timestep}

  \input{01-bayesian-network-basics/02-third-timestep-sol}

  \input{01-bayesian-network-basics/03-interpret}

  \input{01-bayesian-network-basics/03-interpret-sol}
